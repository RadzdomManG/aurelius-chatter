...
5. Set `NEXT_PUBLIC_APP_URL` to `https://aureliuschatters.vercel.app`.
6. Register `https://aureliuschatters.vercel.app/api/fanvue/oauth/callback` as the Fanvue OAuth callback.
7. Register `https://aureliuschatters.vercel.app/api/webhooks/fanvue` as the Fanvue webhook endpoint.
